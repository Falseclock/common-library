...
final class DateUtils
{
     ...
     * @return bool
     */
    public static function isDateStringValid($dateString): bool
    {
        if (preg_match_all(self::VALID_DATE_REGEXP, $dateString, $matches, PREG_SET_ORDER) || preg_match(self::VALID_BROWSER_DATE_REGEXP, $dateString)) {
            return true;
        }
